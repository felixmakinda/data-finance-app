...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240] mx-auto px-4 text-white ">
      <h1 className="font-bold text-transparent text-3xl bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
        Pesa.
      </h1>
      ...
      >
        <h1 className="font-bold text-transparent text-3xl bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 m-4">
          Pesa.
        </h1>
